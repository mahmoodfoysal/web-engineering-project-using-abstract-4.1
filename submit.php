    ...
    <div class="container-fluid">
        ...
        <div class="full">
                        ...
                        <div class="form-row div0">
                            <div class="col-md-3 div1">
                                <div class="form-group">
                                    ...
                                    <select name="drawing_roomf" class="form-control poshytip-hover dissty " title="Select floor number(optional)">
                                        <option selected value="">Choose...</option>
                                        <option value="N/A">N/A</option>
                        ...
                        <div class="form-row div10">
                            ...
                            <div class="col-md-3">
                                <div class="form-group div12">
                                    ...
                                    <select name="community_hall" class="div111 dissty form-control poshytip-hover" title="Select Floor Type*">
                                        <option selected value="" disabled>Floor Type</option>
                                        <option value="N/A">N/A</option>
                                        <option value="YES">YES</option>
                                        <option value="NO">NO</option>
            ...
            if($_POST['submit'])
            {
                ...
                $drawing_roomf = $_POST['drawing_roomf'];
                $lift = $_POST['lift'];
                $gas = $_POST['gas'];
                ...
                if($offertype!="" && $propertytype!=""  && $ad_title!=""  && $ad_description!=""  && $ad_property_size!=""  && $ad_floor_no!=""  && $ad_beds!=""  && $ad_baths!=""  && $ad_balconies!=""  && $ad_floor_type!=""  && $ad_dining_room!=""  && $ad_car_parking!=""  && $drawing_roomf!=""  && $lift!=""  && $gas!="" 
                    && $generator!=""  && $wasa_connection!=""  && $community_hall!=""  && $cctv!="" && $wifi!="" && $ad_amount!=""  && $filename!=""  && $ad_districts!=""  && $ad_area!=""  && $ad_address!=""  && $latitude!=""  && $lngnitude!="" && $date!="")
                {
                    $query = "INSERT INTO SUB4 VALUES ('$id', '$offertype', '$propertytype', '$ad_title', 
                    '$ad_description', '$ad_property_size', '$ad_floor_no',  '$ad_beds', '$ad_baths' , '$ad_balconies' , '$ad_floor_type' , '$ad_dining_room' , '$ad_car_parking', '$drawing_roomf', '$lift', '$gas',
                    '$generator', '$wasa_connection', '$community_hall', '$cctv', '$wifi', '$ad_amount' , '$folder' , '$ad_districts' , '$ad_area' , '$ad_address' ,'$latitude' , '$lngnitude' ,
                     '$date')";
